...
<div dir="rtl" style="text-align: right;">
    ...
    <img src="Proportion of Job Postings by Region.png" alt="توزيع نسبة الوظائف حسب المنطقة" width="600">
    <br><br>
    ...
    <img src="comptype.png" alt="نوع الشركات" width="600">
    <br><br>
    ...
    <img src="compsize.png" alt="حجم الشركات" width="600">
    <br><br>
    ...
    <img src="Expected Salary Range for Fresh Graduates.png" alt="توقعات الراتب للخريجين الجدد" width="600">
    <br><br>
    ...
    <img src="Gender Preference in Job Postings.png" alt="تفضيلات الجنس في الوظائف" width="600">
    <br><br>
    ...
    <img src="Individuals vs. Fresh Graduates.png" alt="فرص العمل للخريجين الجدد مقابل أصحاب الخبرة" width="600">
    <br><br>
